...
from .grounding_det_dataset import GroundingDetDataset
...
def collate_fn(
    ...
    #         print(f'--------need total length {input_ids.shape[1]+255}---------')
...
class ValDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        if len(splits) == 2:
            ...
            refer_api = REFER(os.path.join(self.base_image_dir, 'refer'), ds, splitBy)
            ...
            for item in loaded_images:
                ...
                if ds == "refclef":
                    item["file_name"] = os.path.join(
                        base_image_dir,'refer', "images/saiapr_tc-12", item["file_name"]
                    )
    ...
    def __getitem__(self, idx):
        ...
        while i < len(sampled_sents):
            ...
            if is_sentence:
                ...
                conv.append_message(conv.roles[1], INS_TOKEN+".")
            else:
                conv.append_message(
                    conv.roles[0],
                    DEFAULT_IMAGE_TOKEN
