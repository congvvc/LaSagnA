...
from .utils import SEG_DET_ANSWER_LIST, SEG_DET_SHORT_QUESTION_LIST
from .box_ops import box_xywh_to_cxcywh
...
class ReferSegDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        DATA_DIR = os.path.join(base_image_dir, "refer")
        ...
        for ds in self.refer_seg_ds_list:
            ...
            for item in loaded_images:
                ...
                if ds == "refclef":
                    ...
                    item["file_name"] = os.path.join(
                        "./dataset/coco/train2014", item["file_name"]
                    )
            ...
            if isinstance(ann_id, list):
                ...
                if -1 in ann_id:
                    ...
                    for ann_id_i in ann_id:
                        ...
                        m_final = m_final | m
                    m = m_final
                    # cur_box = self.box_norm(torch.tensor(ann["bbox"], dtype=torch.float32), ori_size)
                masks.append(m)
