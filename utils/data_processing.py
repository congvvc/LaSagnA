...
if __name__ == "__main__":
    data_dir = "./dataset/ReasonSeg/train"
    ...
    for json_path in tqdm(json_path_list):
        ...
        valid_mask = (mask == 1).astype(np.float32)
        this_mask = torch.from_numpy(valid_mask).unsqueeze(0)
        this_box = masks_to_boxes(this_mask).squeeze()
        anno['box'] = this_box.tolist()

        with open(new_json_path, 'w') as new_f:
            json.dump(anno, new_f, indent=2)
