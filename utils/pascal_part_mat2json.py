...
if __name__ == '__main__':
    ...
    parser.add_argument('--split_path', default='./dataset/VOCdevkit/VOC2010/ImageSets/Main')
    parser.add_argument('--split', default='train.txt')
    parser.add_argument('--ann_path', default='./dataset/pascal_part/trainval/Annotations_Part')
