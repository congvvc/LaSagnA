...
from utils.utils import DEFAULT_IM_END_TOKEN, DEFAULT_IM_START_TOKEN, INPUT_CAT_START_TOKEN, INPUT_CAT_END_TOKEN, SEM_SEG_TASK_TOKEN, INS_TOKEN,  NO_INS_TOKEN
...
def parse_args(args):
    ...
    parser.add_argument("--save_path", default="./LaSagnA_model", type=str, required=True)
...
def main(args):
    ...
    model = LaSagnAForCausalLM.from_pretrained(
